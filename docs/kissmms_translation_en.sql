/*
Here are the translations for English
*/

INSERT INTO `core_lang` (`id`, `txkey`, `lang`, `content`) VALUES
...
(6,	'menuitem_kiss_aup_new_user.php',	'en',	'Terms and Conditions'),
(8,	'bannertitle_kiss_aup_new_user.php',	'en',	'AUP'),
...
(12,	'agree_policy',	'en',	'I have read and agree to the <a href=\"kiss_aup_new_user.php\">Terms and Conditions and Privacy Policy</a>'),
...
(40,	'pagetitle_kiss_reg_save.php',	'en',	'Account Saved'),
(41,	'bannertitle_kiss_reg_save.php',	'en',	'Account Saved'),
...
(48,	'pagetitle_kiss_acc_link.php',	'en',	'Account Linking'),
(49,	'bannertitle_kiss_acc_link.php',	'en',	'Account Linking'),
...
(55,	'menuitem_kiss_acc_link.php',	'en',	'Account Linking'),
...
(67,	'bannertitle_kiss_attr_edit.php',	'en',	'Edit Attribute'),
(68,	'pagetitle_kiss_attr_edit.php',	'en',	'Edit Attribute'),
(69,	'you_cannot_edit_this_attribute',	'en',	'You cannot edit this attribute.'),
(70,	'value_validation_fail',	'en',	'Invalid attribute value: %s. '),
(71,	'pagetitle_kiss_attr_edit_save.php',	'en',	'Edit Attribute'),
(72,	'bannertitle_kiss_attr_edit_save.php',	'en',	'Edit Attribute'),
...
(85,	'pagetitle_kiss_email_verify.php',	'en',	'Verify Email'),
(86,	'bannertitle_kiss_email_verify.php',	'en',	'Verify Email'),
(87,	'token_already_consumed',	'en',	'Email already verified: %s.'),
(88,	'pagetitle_kiss_audit_logs.php',	'en',	'Audit Logs'),
(89,	'bannertitle_kiss_audit_logs.php',	'en',	'Audit Logs'),
